...
- `breakout_power`: 1-minute BreakOut Power score cross above trend line with green avg_momentum, SuperTrend(10,2) entry filter, profit partials at 0.8R/0.8%, optional SuperTrend-bearish exit, and bar-based recovery-aware exits (defaults tuned from replay `st_test_2`)
