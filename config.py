...
class Settings:
    ...
    gap_and_go_reclaim_pct: float = 0.95
    gap_and_go_confirm_breakout: bool = False
    gap_and_go_confirm_bars: int = 2
    gap_and_go_use_stop_loss: bool = True
    gap_and_go_stop_loss_pct: float = 0.03
    gap_and_go_swing_lookback: int = 5
    gap_and_go_stop_buffer_pct: float = 0.001
    gap_and_go_min_r_pct: float = 0.005
    gap_and_go_max_r_pct: float = 0.04
    gap_and_go_partial_r: float = 1.0
    gap_and_go_partial_size: float = 0.5
    gap_and_go_volume_collapse_enabled: bool = True
    gap_and_go_volume_collapse_ratio: float = 0.3
    gap_and_go_volume_collapse_min_bars: int = 3
    gap_and_go_max_premarket_extension_pct: float = 0.10
    ...
    liquidity_scalper_end_minute: int = 360
    liquidity_scalper_afternoon_start_minute: int = 0
    ...
    liquidity_scalper_tape_accel_min_ratio: float = 1.15
    liquidity_scalper_exit_tape_reversal_ratio: float = 1.35
    ...
    liquidity_scalper_trailing_pullback_pct: float = 0.002
    liquidity_scalper_stall_seconds: int = 12
    ...
    stoch_macd_max_trades_per_symbol_per_session: int = 3
    stoch_macd_symbol_loss_lock_count: int = 2
    stoch_macd_hardening_max_spread_bps: float = 15.0
    ...
    stoch_macd_neutral_hist_multiplier: float = 1.60
    stoch_macd_neutral_volume_add: float = 0.15
    ...
    egc_max_spread_bps: float = 12.0
    egc_min_gap_pct: float = 0.0003
    ...
    egc_max_trades_per_symbol_per_session: int = 3
    egc_symbol_loss_lock_count: int = 2
